        ...
        for file in sequence_files:
            ...
            if self.augment:
                if random.random() < 0.5:
                    frames, masks = self._apply_augmentation(frames, masks, "rotate")
                if random.random() < 0.5:
                    frames, masks = self._apply_augmentation(frames, masks, "brightness_contrast")
                if random.random() < 0.5:
                    frames, masks = self._apply_augmentation(frames, masks, "gaussian_noise")
