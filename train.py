import sys
sys.path.append(r"C:\Users\Administrator\Desktop\Projects\Surgical\LaparoSeg\model")
...
def parse_args():
    ...
    parser.add_argument("--patience",           type = int,  default = 10,     help = "Number of epochs withoput improvement to wait before early stopping.")
...
if __name__ == '__main__':
    ...
    # Training arguments
    data_dir           = r"D:\SLUdata\DSADtensor\dresden_tensors" #args.data_dir
    ...
    train_vids_1 = {4, 5, 8, 10, 12, 22, 23, 24, 25, 27, 29, 30, 31} #16 17
    val_vids_1   = {2, 7, 11, 18, 20}
    test_vids_1  = {3, 21, 26, 16, 17,}
    ...
    dataset_1.augment = True
    train_set_1 = Subset(dataset_1, train_indices_1)
    dataset_1.augment = False
